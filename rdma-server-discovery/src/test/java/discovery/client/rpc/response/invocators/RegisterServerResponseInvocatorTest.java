...
public class RegisterServerResponseInvocatorTest {
    ...
    public void responseInvocationTest(){
        ...
        responseManager.registerServerPendingResponses().put(0L, membersResponse);
        // We can now create an invocator to get the registered servers and pass it this manager.
        RegisterServerResponseInvocator invocator = new RegisterServerResponseInvocator(responseManager);
