...
public class RdmaTwoSidedEndpointFactory implements RdmaEndpointFactory<RpcBasicEndpoint> {

    private RdmaActiveEndpointGroup<RpcBasicEndpoint> endpointGroup;
    private int maxBufferSize;
    private int maxWRs;

    public RdmaTwoSidedEndpointFactory(RdmaActiveEndpointGroup<RpcBasicEndpoint> endpointGroup,
    ...
    public RpcBasicEndpoint createEndpoint(RdmaCmId id, boolean serverSide) throws IOException {
        ClientCompletionHandlerTS handler = new ClientCompletionHandlerTS();
